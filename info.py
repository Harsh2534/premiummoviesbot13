...
BOT_TOKEN = environ.get('BOT_TOKEN', "5909962394:AAEfMlLFg850dFQeqO4D33FXXiKY8nG8ZJI")

# Bot settings
CACHE_TIME = int(environ.get('CACHE_TIME', 1800))
PICS = (environ.get('PICS', 'https://graph.org/file/a6b3420f0d7b34bd29631.jpg')).split() #SAMPLE PIC
...
auth_channel = environ.get('AUTH_CHANNEL', '-1001948462404') # give your force subscribe channel id here else leave it blank
...
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '-1002180043646').split()]

# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://pro1:pro@cluster0.17gkvct.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/tutorials0128/31')
...
VERIFY_TUTORIAL = environ.get('VERIFY_TUTORIAL', 'https://t.me/tutorials0128/26')

# Shortlink Info
SHORTLINK_MODE = bool(environ.get('SHORTLINK_MODE', True))
SHORTLINK_URL = environ.get('SHORTLINK_URL', 'luckyurl.in')
SHORTLINK_API = environ.get('SHORTLINK_API', '5632c50c864a53d815da3d126b2ae535fa674b94')

# Others
MAX_B_TN = environ.get("MAX_B_TN", "5")
PORT = environ.get("PORT", "8880")
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
URL = environ.get("URL", "https://agreeable-lisette-rajkundra35626-11b1a42f.koyeb.app/")
